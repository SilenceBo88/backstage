...
import com.zb.backstage.core.systemlog.SystemLogQueue;
import com.zb.backstage.core.util.ApplicationUtil;
import com.zb.backstage.core.util.IpUtil;
...
/**
 * @Author: zb
 * @Date: Created in 2018/5/31 20:25
...
public class AspectLog {
     ...
     * 定义切点
     */
    @Pointcut("@annotation(com.zb.backstage.core.aop.AnnotationLog)")
    ...
    private SystemLog getSystemLogInit(JoinPoint p){
        ...
        try{
            ...
            //大家可自行百度获取ip的方法
            systemLog.setRequestIp(IpUtil.getIp(request));
